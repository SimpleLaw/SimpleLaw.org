function law(item){//links to the appropriate state law site
	window.location = "http://www.simplelaw.org/laws.php?state="+item.id;
	//var name=prompt("What is the name of the state?",item.id);
	//item.id=name;
}
...
return ["Found it! Just a placeholder.","b","c"];
}